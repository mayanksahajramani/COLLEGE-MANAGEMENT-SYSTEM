...
public class TeacherController {
    ...
    @ResponseBody
    String updateSingleTeacherSelf(@RequestBody Teacher teachers){
        return service.updateSingleTeacher(teachers);

    }
    @RequestMapping("/read-single-teacher-self")
    @ResponseBody
    Student readSingleTeacher(@RequestParam int id)
    {
        return service.readSingleTeacher(id);
    }
}
